    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView
        ...
        <View style={styles.gender_select_view}>
          ...
          <Text style={[styles.test_style, styles.extra_style]}>Male</Text>
          <TouchableOpacity
            style={[
          ...
          <Text style={[styles.test_style, styles.extra_style]}>Female</Text>
          <TouchableOpacity
            style={[
              styles.selectgender_button,
              {marginLeft: moderateScale(15)},
          ...
          <Text style={[styles.test_style, styles.extra_style]}>Others</Text>
        </View>
        <Text style={[styles.field_title, {marginTop: moderateScale(20)}]}>
          Date of Birth
        </Text>
